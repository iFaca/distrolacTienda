      ...
      <div className="methods-section">
        <div className="methods-column">
          ...
          <p className="methods-description">
            Los pagos se realizan una vez que el pedido llegó a tu domicilio y
            estás conforme con tu compra. Los medios de pago disponibles son
        ...
        <div className="methods-column">
          ...
          <p className="methods-description">
            ...
            coordinemos la entrega de tu pedido con uno de nuestros asesores.
          </p>
        </div>
      </div>
