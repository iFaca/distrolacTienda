...
export default function Profile() {
    ...
    try {
      ...
      if (profileData) {
        ...
        const updatedFormData = {
          ...
          dni: profileData.dni || userInfo.dni || "",
          alias: profileData.alias || userInfo.alias || "",
        };
  ...
  const handleChange = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    if (name === "phone" || name === "address") {
      try {
        ...
        handleShowAlert("Error al guardar datos", "error");
      }
    }
  };
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      handleShowAlert("Perfil actualizado con éxito", "success");
      ...
      handleShowAlert(
        err?.data?.message || "Error al actualizar el perfil",
        "error"
      );
    }
  };
  ...
  const handlePasswordSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      handleShowAlert("Contraseña actualizada con éxito", "success");
      setPasswordData({
        currentPassword: "",
        newPassword: "",
        confirmNewPassword: "",
      ...
      handleShowAlert(
        err?.data?.message || "Error al cambiar la contraseña",
        "error"
      );
    } finally {
